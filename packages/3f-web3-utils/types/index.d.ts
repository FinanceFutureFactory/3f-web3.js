...
export function to0xAddress(value: string): string;
export function toFFFAddress(value: string): string;
// interfaces
export interface Utils {
    ...
    to0xAddress(value: string): string;
    toFFFAddress(value: string): string;
}

 ...
 *
 *  var Contract = require('3f-web3-eth-contract');
...
var core = require('3f-web3-core');
var Method = require('3f-web3-core-method');
var utils = require('3f-web3-utils');
var Subscription = require('3f-web3-core-subscriptions').subscription;
var formatters = require('3f-web3-core-helpers').formatters;
var errors = require('3f-web3-core-helpers').errors;
var promiEvent = require('3f-web3-core-promievent');
var abi = require('3f-web3-eth-abi');
    ...
    // create topics based on filter
        ...
        if (event.name !== 'ALLEVENTS') {
            var indexedTopics = event.inputs.filter(function (i) {
                ...
                // TODO: https://github.com/FinanceFutureFactory/3f-web3.js/issues/344
